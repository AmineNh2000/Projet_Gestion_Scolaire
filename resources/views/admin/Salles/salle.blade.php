                ...
                <div class="card-body ">
                  ...
                  <div class="row py-4">
                    ...
                    <div class="col-md-6">
                      <div class="d-flex flex-row-reverse">
                        <a href="{{route('admin.FormSalle')}}"  class=" me-2 btn btn-primary me-0">Ajouter un nouveau salle</a>
                        <div class="p-2"></div>
                        <div class="p-2"></div>
                      </div>
                    </div>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row"><a href="#">#{{ $Salle->id }} </a></th>
            
                        <td><a href="#" class="text-center">{{ $Salle->nom }}</a></td>
                        <td class=""><a href="#" class="text-primary ">{{ $Salle->capacite }}</a></td>
                        <td><a href="#" class="text-primary">{{ $Salle->description }}</a></td>
                        {{-- <td><span class="badge bg-success">{{ $Salle->disponibilite }}</span></td> --}}
                        <td>
                          @if($Salle->disponibilite == 'occupée')
                              <span class="badge bg-warning w-50 fs-6">{{ $Salle->disponibilite }}</span>
                          @else
                              <span class="badge bg-success w-50 fs-6">{{ $Salle->disponibilite }}</span>
                          @endif
                      </td>
                      
                        <td>

                          <form method="POST" action="{{ route('admin.destroySalle',$Salle->id ) }}" id="{{$Salle->id}}">
                            @csrf
