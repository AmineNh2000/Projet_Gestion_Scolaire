                    ...
                    <div class="col-lg-12 grid-margin stretch-card m-0">
                      <div class="card">
                        <div class="card-body mt-0">
                          ...
                          <form id="signupForm" method="POST" action="{{ route('admin.AddSalle') }}">
                            @csrf
                            @method('POST')
                            ...
                            <div class="mb-3 col-lg-6">
                              <label for="prenom" class="form-label ">Capacite</label>
                              <input id="prenom" class="form-control" name="capacite" type="number" value="{{ old('capacite') }}">
                              @error('capacite')
                                  <div class="text-danger">{{ $message }}</div>
                              @enderror
                          </div>
                          ...
                          <div class="mb-3 col-lg-6">
                            <label for="image" class="form-label">Disponibilite:</label>

                            <select class="form-select form-select-sm" name="disponibilite" aria-label="Small select example">
                              <option selected disabled>Ouvrire le Menu</option>
