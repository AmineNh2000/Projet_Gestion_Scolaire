                ...
                <div class="card-body ">
                  ...
                  <div class="row py-4">
                    ...
                    <div class="col-md-6">
                      <div class="d-flex flex-row-reverse">
                        <a href="{{route('admin.FormDepartement')}}"  class=" me-2 btn btn-primary me-0">Ajouter un nouveau departement</a>
                        <div class="p-2"></div>
                        <div class="p-2"></div>
                      </div>
                    </div>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row"><a href="#">#{{ $Departement->id }} </a></th>
            
                        <td><a href="#" class="text-center">&nbsp;&nbsp;{{ $Departement->nom_Departement }}</a></td>
                        <td class=""><a href="#" class="text-primary "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ \Carbon\Carbon::parse($Departement->created_at)->format('d-m-Y') }}</a></td>
                        <td class=""><a href="#" class="text-primary "> &nbsp;&nbsp;&nbsp;{{ $Departement->description }}</a></td>

                        <td>

                          
    
                              <form method="POST" action="{{ route('admin.destroyDepartement',$Departement->id ) }}" id="{{$Departement->id}}">
                                @csrf
