                  ...
                  <div class="row py-4">
                    ...
                    <div class="col-md-6">
                      <div class="d-flex flex-row-reverse">
                        <a href="{{route('admin.AddEtudiant')}}"  class=" me-2 btn btn-primary me-0">Ajouter un nouveau etudiant</a>
                        <div class="p-2"></div>
                        <div class="p-2"></div>
                      </div>
                    </div>
                  ...
                  <table class="table table-borderless datatable" id="myTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="#" class="text-primary">{{ $Etudiant->name }}</a></td>
                        <td><a href="#" class="text-primary">{{ $Etudiant->Prenom }}</a></td>
                        <td><a href="#" class="text-primary">{{ $Etudiant->email }}</a></td>
                        <td><span class="badge bg-success w-100">{{ $Etudiant->phone_number}}</span></td>
                          ...
                          <td>
                            ...
                            <div class="d-flex flex-row ">
                              <div class="me-1">
                                <a  href="{{ route('admin.ShowEtudiant',$Etudiant->id) }}"  class="btn btn-light bg-primary w-100" style="color: white" >
                                  Voir
                                  </a>
                              </div>
                              <div class="">
                                <form method="POST" action="{{ route('admin.destroyEtudiants',$Etudiant->id ) }}" id="{{$Etudiant->id}}">
                                  @csrf
